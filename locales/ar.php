...
return [
    ...
    // Glossary
    'leverage.glossary.title' => 'قاموس المصطلحات',
    'leverage.glossary.button' => 'المصطلحات',
    'leverage.glossary.leverage' => 'الرافعة المالية',
    'leverage.glossary.leverage_desc' => 'نظام يراقب أسعار الأصول وفقاً للعتبات التي تحددها. ينتج إشارات تلقائياً ويرسل إشعارات عندما يتجاوز السعر عتبة معينة.',
    'leverage.glossary.reference_price' => 'السعر المرجعي',
    'leverage.glossary.reference_price_desc' => 'نقطة البداية التي تُحسب منها تغيرات الأسعار. مثلاً إذا كان المرجع 100₺ والسعر الحالي 85₺، فالتغير هو -15%.',
    'leverage.glossary.update_reference' => 'تحديث المرجع',
    'leverage.glossary.update_reference_desc' => 'يعيد تعيين السعر المرجعي إلى السعر الحالي. يُستخدم لبدء دورة جديدة بعد تفعيل إشارة. يتم تحديثه تلقائياً بعد الإشارات القوية.',
    'leverage.glossary.buy_threshold' => 'عتبة الشراء',
    'leverage.glossary.buy_threshold_desc' => 'عندما ينخفض السعر بهذه النسبة من المرجع، تُنتج إشارة "شراء". مثلاً عند -15%، تصدر إشارة عندما ينخفض السعر 15% عن المرجع.',
    'leverage.glossary.sell_threshold' => 'عتبة البيع',
    'leverage.glossary.sell_threshold_desc' => 'عندما يرتفع السعر بهذه النسبة من المرجع، تُنتج إشارة "بيع". مثلاً عند +30%، تصدر إشارة عندما يرتفع السعر 30% فوق المرجع.',
    'leverage.glossary.weak_threshold' => 'العتبة الضعيفة',
    'leverage.glossary.weak_threshold_desc' => 'إشارة إنذار مبكر تصدر قبل العتبة القوية. لا تُفعّل تحليل الذكاء الاصطناعي ولا تغير السعر المرجعي. للمعلومات فقط.',
    'leverage.glossary.trailing_stop' => 'الإيقاف المتحرك',
    'leverage.glossary.trailing_stop_desc' => 'يتتبع أعلى سعر أثناء الارتفاع وينتج إشارة عند انخفاضه بنسبة معينة من القمة. وضعان: تلقائي (يتتبع القمة) وعتبة (يتتبع الانخفاض من المرجع).',
    'leverage.glossary.peak_price' => 'سعر القمة',
    'leverage.glossary.peak_price_desc' => 'أعلى سعر مسجل في الوضع التلقائي للإيقاف المتحرك. تصدر إشارة عندما ينخفض السعر من هذه القمة بالنسبة المحددة.',
    'leverage.glossary.backtest' => 'اختبار رجعي',
    'leverage.glossary.backtest_desc' => 'يحاكي قواعدك على بيانات الأسعار التاريخية لمعرفة كيف كان أداؤها. يعرض العائد الإجمالي، أقصى تراجع، ومعدل الربح.',
    'leverage.glossary.ai_analysis' => 'تحليل الذكاء الاصطناعي',
    'leverage.glossary.ai_analysis_desc' => 'عند تفعيل إشارة، يقيّم الذكاء الاصطناعي (Gemini) ظروف السوق ويقدم توصية شراء/بيع/احتفاظ. يأخذ بعين الاعتبار وضع المحفظة واتجاه الأسعار ونسبة الذهب/الفضة.',
    'leverage.glossary.signal' => 'إشارة',
    'leverage.glossary.signal_desc' => 'إشعار يُنتج عندما يتجاوز السعر عتبة. إشارات الشراء عند انخفاض الأسعار، وإشارات البيع عند ارتفاعها.',
    'leverage.glossary.cooldown' => 'فترة الانتظار',
    'leverage.glossary.cooldown_desc' => 'الحد الأدنى للوقت بين إشارتين. يمنع صدور إشارات كثيرة متتالية لنفس القاعدة. الافتراضي: 60 دقيقة.',
    'leverage.glossary.direction_lock' => 'قفل الاتجاه',
    'leverage.glossary.direction_lock_desc' => 'يمنع صدور نفس إشارة الاتجاه مرة أخرى. بعد إشارة "شراء"، لن تصدر "شراء" جديدة ما لم يعد السعر إلى المرجع ثم ينخفض مجدداً.',
    'leverage.glossary.webhook' => 'ويب هوك',
    'leverage.glossary.webhook_desc' => 'يرسل إشعارات تلقائياً إلى عناوين URL المحددة عند إنتاج إشارة. يتيح التكامل مع Discord و Slack أو أنظمتك الخاصة.',
    'leverage.glossary.source_type' => 'نوع المصدر',
    'leverage.glossary.source_type_desc' => 'يحدد البيانات التي تتبعها القاعدة. عملة: تتبع مباشر للسعر. مجموعة: أصل ضمن مجموعة محفظة. علامة: أصل ضمن علامة محفظة.',
