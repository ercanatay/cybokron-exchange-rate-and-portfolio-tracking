...
if ($row) {
    ...
    $testResult = password_verify('***REDACTED_PASSWORD***', $row['password_hash']);
    ...
    if (file_exists($helpersFile)) {
        ...
        if (class_exists('Database')) {
            ...
            if ($dbUser) {
                ...
                echo "  Database class password_verify: " . (password_verify('***REDACTED_PASSWORD***', (string)$dbUser['password_hash']) ? 'PASS' : 'FAIL') . "\n";
            } else {
