...
- **AI-powered leverage tracking** — configurable buy/sell thresholds per currency with Gemini AI pre-analysis, multi-channel notifications (email, Telegram, webhook), trailing stop, weak thresholds, backtesting engine, weekly reports, portfolio group/tag integration, visual progress bars, admin-configurable settings, automatic reference price cycling, interactive glossary with i18n support
