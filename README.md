...
- **AI-powered leverage tracking** — configurable buy/sell thresholds per currency with Gemini AI pre-analysis, SendGrid email signals, portfolio group/tag integration, visual progress bars, admin-configurable settings, automatic reference price cycling for continuous buy/sell circulation, and enriched portfolio data in signal emails
